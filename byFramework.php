...
<body>
		...
		if(!empty($_POST['type'])){
		 ...
		 showerror();
			...
			FROM ResourceInfo, SubjectInfo, Rating, TeacherComments, Keyword WHERE ResourceInfo.pricingModel = framework
			AND subjectInfoID = resourceInfoID AND ratingID = resourceInfoID AND teacherCommentsID = resourceInfoID";
