...
<body>
		...
		if(!empty($_POST['type'])){
		 ...
		 showerror();
			...
			FROM ResourceInfo, SubjectInfo, Rating, TeacherComments, Keyword WHERE rating.rating >= rating AND resourceInfoID = ratingID 
			AND teacherCommentsID = ratingID AND subjectInfoID = ratingID AND teacherCommentsID = ratingID;";
