...
<body>
		...
		if(!empty($_POST['type'])){
		 ...
		 showerror();
			...
			FROM ResourceInfo, SubjectInfo, Rating, TeacherComments, Keyword WHERE teachingEnvironment = environment AND resourceInfoID = subjectInfoID
			AND teacherCommentsID = subjectInfoID AND ratingID = subjectInfoID";
