...
<body>
		...
		if(!empty($_POST['type'])){
		 ...
		 showerror();
			...
			FROM ResourceInfo, SubjectInfo, Rating, TeacherComments, Keyword WHERE resourceInfo.topic = topic AND SubjectInfoID = resourceInfoID 
			AND ratingID = resourceInfoID AND teacherCOmmentsID = resourceInfoID;";
